...
Operation = st.sidebar.selectbox("Operation", ("Hip joint replacement", "Internal fixation", "Conservative"))
...
if st.button("Submit"):
    ...
    x = x.replace(["Hip joint replacement", "Internal fixation", "Conservative"], [1, 2, 3])
